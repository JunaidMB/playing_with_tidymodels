...
fields <- sort(rep.int(c(1:5), 50))
quads <- rep(c(1:5), 50)
values <- rnorm(n = 250, mean = 3)
crop <- sample(x = c("linseed", "barley", "olive", "potato", "cauliflower"), size = 250, replace = TRUE, prob = c(0.5, 0.2, 0.05, 0.20, 0.05))
red_density_state <- sample(x = c(1,2,3), size = 250, replace = TRUE, prob = c(0.5, 0.4, 0.1))
junk_col1 <- rnorm(n = 250, mean = 50)
junk_col2 <- rnorm(n = 250, mean = 40)
junk_col3 <- rnorm(n = 250, mean = 30)
